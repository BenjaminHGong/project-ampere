...
script.on_event(defines.events.on_player_joined_game, function(event)
	...
	FactoCordIntegration.PrintToDiscord(":wave: **" .. p.name .. "** has joined!");
	p.print("" .. p.name .. " has joined!");
end)

script.on_event(defines.events.on_player_left_game, function(event)
	local p = game.players[event.player_index];
	FactoCordIntegration.PrintToDiscord(":wave: **" .. p.name .. "** has left!");
end)
...
script.on_event(defines.events.on_research_started, function(event)
	...
	FactoCordIntegration.PrintToDiscord(":hourglass: Research started: **" .. research.localised_name .. "**" .. by_player);
end)
...
script.on_event(defines.events.on_research_finished, function(event)
	...
	FactoCordIntegration.PrintToDiscord(":rocket: Research finished: **" .. research.localised_name .. "**" .. by_player);
end)
